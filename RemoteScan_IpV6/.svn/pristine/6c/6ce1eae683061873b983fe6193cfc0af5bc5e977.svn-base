...
enum  HTTP_POST_MODE_LEGACY
{
	HTTP_POST_ADD_LEGACY = 1,				// プロファイル登録
	HTTP_POST_MOD_LEGACY,					// プロファイル更新
	HTTP_POST_DEL_LEGACY					// プロファイル削除
};

enum  HTTP_USERA_MODE_LEGACY
{
	HTTP_USERA_INVALID_LEGACY = 0,			// 無効
	HTTP_USERA_VALID_LEGACY				// 有効
};

@interface HttpLegacyManeger : NSObject
{
	//
	// インスタンス変数宣言
	//
    ...
    NSMutableDictionary *addDic;                    // post時のキー情報
    NSMutableDictionary *updateDic;                 // post時のキー情報
    NSMutableDictionary *deleteDic;                 // post時のキー情報

    int extendSharpSettingStatus;                   // Extend Sharp Setting Status
}
//
// プロパティの宣言
//
...
@property (nonatomic, strong) NSMutableDictionary *addDic;      // post時のキー情報
@property (nonatomic, strong) NSMutableDictionary *updateDic;   // post時のキー情報
@property (nonatomic, strong) NSMutableDictionary *deleteDic;   // post時のキー情報
