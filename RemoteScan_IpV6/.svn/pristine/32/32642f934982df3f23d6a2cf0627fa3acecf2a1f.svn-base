...
#define SnmpCommunityStringCell_HEIGHT 210
#define RegularCell_HEIGHT 44
@interface SettingApplicationViewController ()
@property (nonatomic,strong) NSArray *deviceNameSettings;
@end

@implementation SettingApplicationViewController
...
- (void)viewDidLoad
{
    ...
    lblTitle.text = S_TITLE_SETTING_APPLICATION;
        ...
        case SNMP_SECTION_APPLICATION:
            switch (indexPath.row) {
                case SNMP_SECTION_COMMUNITY_STRING:
                    return SnmpCommunityStringCell_HEIGHT +10;
                    break;
                default:
                    break;
            }
...
- (UITableViewCell *)getCommunityString:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    frame.size.height = SnmpCommunityStringCell_HEIGHT;
