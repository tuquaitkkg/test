...
- (void)viewDidLoad
{
    ...
    lblTitle.text = S_TITLE_SETTING_USER;
        ...
        @try {
            ...
            else if (sectionId == 2)
            {
                if(indexPath.row == 0)
                {
                    ...
                    self.loginNameCell.nameEditableCell.textField.tag	= 4;
                ...
                else
                {
                    ...
                    self.loginPasswordCell.nameEditableCell.textField.tag	= 5;
...
-(IBAction)dosave:(id)sender
{
    ...
    // 表示名
    if (self.nameCell.nameEditableCell.textField) {
        profileData.profileName	= self.nameCell.nameEditableCell.textField.text;
    }
    
    // 検索文字
    if (self.sercCell.nameEditableCell.textField) {
    ...
    {// ログイン名を使用
        // ユーザー名
        if (self.loginNameCell.nameEditableCell.textField) {
            profileData.loginName = self.loginNameCell.nameEditableCell.textField.text;
        }
        
        // パスワード
        if (self.loginPasswordCell.nameEditableCell.textField) {
    ...
    {// ユーザー番号を使用
        ...
        // ユーザー番号
        if (self.userNoCell.nameEditableCell.textField) {
    ...
    // デフォルトジョブ　ユーザー名
    if (self.userNameCell.nameEditableCell.textField) {
        profileData.userName = self.userNameCell.nameEditableCell.textField.text;
    }
    
    // デフォルトジョブ　ジョブ名
    if (self.jobNameCell.nameEditableCell.textField) {
