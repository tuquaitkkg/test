...
@interface ScanBeforePictViewController_iPad : PictureViewController_iPad
{
    ...
    BOOL                    m_IsRecComp;
    BOOL                    m_isScanStop;
    BOOL                    m_isShowAlert; // 初期表示時のアラート表示フラグ // iPad用
    BOOL                    m_isShowMenu;  // 初期表示時のメニュー表示フラグ // iPad用
...
@property (nonatomic)           BOOL                isShowAlert;      // 初期表示時のアラート表示フラグ // iPad用
@property (nonatomic)           BOOL                isShowMenu;      // 初期表示時のメニュー表示フラグ // iPad用
