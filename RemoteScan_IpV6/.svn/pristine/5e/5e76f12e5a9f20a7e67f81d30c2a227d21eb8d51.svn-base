...
@interface SettingApplicationViewController : UITableViewController <UITextFieldDelegate,UITextViewDelegate,SettingDeviceNameInfoTableViewControllerDelegate>{
