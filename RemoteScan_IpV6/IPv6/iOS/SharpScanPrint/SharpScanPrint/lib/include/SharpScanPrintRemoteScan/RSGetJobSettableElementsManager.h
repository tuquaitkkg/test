...
@interface RSGetJobSettableElementsManager : RSHttpCommunicationManager
{
    // カラーモード
    ...
    RSSettableElementsData *rsSettableElementsData;
}
...
@property(nonatomic, readonly) RSSettableElementsData *rsSettableElementsData;
