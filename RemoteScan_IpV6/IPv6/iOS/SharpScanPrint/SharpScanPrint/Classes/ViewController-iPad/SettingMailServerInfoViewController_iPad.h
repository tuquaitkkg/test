...
// iPad用
@protocol UpdateSettingUserInfoViewController
- (void)popRootView;
- (void)setPortraitMenu:(UIBarButtonItem *)barButtonItem;
@end
// iPad用

@interface SettingMailServerInfoViewController_iPad : UITableViewController<UITextFieldDelegate,UITextViewDelegate, UINavigationControllerDelegate,SettingSelMailDisplayTableViewControllerDelegate>
{
	// インスタンス変数宣言
	//
